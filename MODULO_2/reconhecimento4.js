...
function setup() {
  ...
  posInput = createVector((innerWidth / 11.5) * 4.5, (innerHeight / 11) * 7);
  ...
  btProxImgVetor = createVector((innerWidth / 14.5) * 10.6, (innerHeight / 14) * 3.3);
  btSomImgVetor = createVector((innerWidth / 54) * 10.6, (innerHeight / 10) * 2);
...
class Bloco {
  ...
  constructor(silabas, erradas, certas, palavra) {
    ...
    this.p2 = createVector(37 * (innerWidth / 80), this.alturaPecas * (innerHeight / 80));
